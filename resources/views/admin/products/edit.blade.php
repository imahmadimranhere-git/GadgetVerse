<x-app-layout>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold mb-0">✏️ Edit Product</h2>
        ...
        <label class="form-check-label" for="is_featured">Show on Home</label>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <img src="{{ asset('storage/' . $product->thumbnail) }}"
                             class="rounded mb-2" style="width: 80px; height: 80px; object-fit: cover;"><br>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="d-flex flex-wrap gap-2 mb-2">
                            ...
                            @empty
                                <span class="text-muted small">Koi gallery image nahi hai.</span>
                            @endforelse
                        </div>
                        <label for="gallery" class="form-label">Add More Images (Optional)</label>
                        <input type="file" name="gallery[]" id="gallery"
                               class="form-control @error('gallery.*') is-invalid @enderror" accept="image/*" multiple>
                        @error('gallery.*')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
